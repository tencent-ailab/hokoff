...
from framework.predictor.predictor.infer_input_output import InferInput, InferOutput
from framework.predictor.predictor.base_predictor import BasePredictor
...
class LocalTFPredictor(BasePredictor):
    ...
    def __init__(self, graph, cpu_num):
        ...
        self._sess_config = tf.ConfigProto(
            device_count={"CPU": cpu_num}, inter_op_parallelism_threads=cpu_num, intra_op_parallelism_threads=cpu_num, log_device_placement=False
        )
